...
const shots = [
  ...
  { name: 'contact-desktop',         url: 'contact.html',                vp: DESK },
  { name: 'contact-mobile',          url: 'contact.html',                vp: MOB, mobile: true },
  { name: 'contact-desktop-nojs',    url: 'contact.html',                vp: DESK, nojs: true },
